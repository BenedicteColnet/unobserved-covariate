...
get_bootstraped_coeff_Robinson <- function(DF, nboot = 10, covariate_names = observed.covariates, init.result){
...
```{r}
sd(total[total$S == 0, "glasgow"])
mean(total[total$S == 0, "glasgow"]) - mean(total[total$S == 1, "glasgow"])
```
