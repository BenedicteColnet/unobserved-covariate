...
```{r}
t.test(total[total$S ==1 & total$A == 1 & total$Y, "Y"], total[total$S ==1 & total$A == 0, "Y"])
```
We can conclude on a treatment effect of the tranexamic acid on the outcome when the mild and moderate injured patient who survived.
...
A statistical test would reject largely assumption 8.
